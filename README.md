...
This image is based on a minimal Alpine Linux image that includes glibc. It provides the official Linux server 64-bit 2.1.3-stable build of Godot Engine along with the official templates.
